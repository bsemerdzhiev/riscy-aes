...
static void aes128_ecb_encrypt(uint8_t *plaintext, uint8_t *key, uint8_t *ciphertext) {
...
int main(void) {
  uint8_t plaintext[16] = {'H','e','l','l','o',',',' ','W','o','r','l','d','!','0','0','0'};
  uint8_t key[16] = {'c','e','s','e','4','0','4','0','p','a','s','s','w','o','r','d'};
